...
Before dive into the coding of [PyTorch](http://pytorch.org/), it is important to first know why PyTorch is developed. As there are lots of deep learning frameworks with great performance and documentation support like [TensorFlow](https://www.tensorflow.org/). 
